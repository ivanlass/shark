    ...
    <div className="modal-wrapper">
        <div className="modal-contents pt-1">
            <button className="modal-close-btn" onClick={()=> setIsOpen(false)}>
                ...
                <p className="text-start" style={{fontWeight:"bold"}}>Cancel Order</p>
            <div className="modal-info-wrapper mt-5">
                <p className="modal-info-labels"><img alt="logo" height="30px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/BTC_Logo.svg/2000px-BTC_Logo.svg.png"/> BTC</p>
