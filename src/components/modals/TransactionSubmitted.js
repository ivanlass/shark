...
function TransactionSubmitted() {
    ...
    <div className={closing?"modal-wrapper slit-out-vertical": "modal-wrapper"}>
        <div className={closing?"modal-contents pt-1 slit-out-vertical": "modal-contents pt-1"}>
            ...
            <button onClick={close} className="btns outline sm-btn size-13">View on explorer</button>
            <button onClick={close} className=" btns full-btn mt-3 mid-btn">View Progress</button>
            </div>
        </div>
    </div>
